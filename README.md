...
I'm pleased to share that I have **successfully completed a Selenium Test Automation Framework**! 🎯

This project was **highly informative** and helped me strengthen my understanding of building **robust, scalable, and maintainable automation frameworks**.
...
The framework focuses on clean architecture, structured test execution, and detailed reporting — reflecting real-world QA automation concepts including test scalability, design pattern implementation, and end-to-end browser automation.
...
| 🔹 Feature | 📘 Description |
|:-:|:-|
| 🗂️ Page Object Model (POM) | Clean architecture · Reusability · Scalability · Separation of concerns |
...
| ⚙️ Alert Handling & Sync | Dynamic element handling · Stable execution · Smart waits & retries |
...
Selenium WebDriver:
  ...
  ✔ Smart Waits & Synchronisation Strategies
...
Testing:
  ...
  ✔ Extent Reports with Pass/Fail Screenshots
...
|:-:|:-:|:-|
| 🟢 Login Module | Authentication | Valid/Invalid login, error messages |
| 🔵 Product Listing | Inventory Page | Sorting, filtering, product display |
| 🟠 Cart Operations | Shopping Cart | Add, remove, update cart items |
| 🔴 Checkout Flow | End-to-End | Complete purchase workflow validation |
...
- **Data-driven testing** and parameterised test execution
- **ExtentReports** integration for interactive HTML reporting
- **Scalable and maintainable** test automation architecture
...
```yaml
Achievement:
  ✔ Selenium Automation Framework   — Completed
