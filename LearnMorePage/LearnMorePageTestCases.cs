...
{
    public class LearnMorePageTestCases : ExtentReport
    {
        [TestClass]
        public class HomePageTestCases : ExtentReport
        {
            ...
            LearnMorePage learnmorepage = new LearnMorePage();
            ...
            [DataSource("Microsoft.VisualStudio.TestTools.DataSource.XML",
                "Data.xml", "ClickOnLearnMore", DataAccessMethod.Sequential)]
            public void ClickOnLearnMore()
            {
                ...
                exChildTest = exParentTest.CreateNode("Click On Header Link Of About Page");
                aboutPage.GetClickHeaderAboutLinkTitle();

                exChildTest = exParentTest.CreateNode("Assert The Main Title Of Learn More Page");
                learnmorepage.LearnMoreMainTitle(message2);
            }
        }
    }
}
